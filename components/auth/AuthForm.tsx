      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-4 text-center">
          <div className="flex justify-center">
            <img src={svitLogo} alt="SVIT Logo" className="h-20 w-20 object-contain" />
          </div>
          <div>
            <CardTitle className="text-2xl font-bold">SVIT ERP System</CardTitle>
            <CardDescription>Attendance Management Portal</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="signup">
              ...
              <p className="text-xs text-muted-foreground text-center mt-4">
                Note: Only whitelisted emails can register. Contact your administrator if you don't have access.
              </p>
            </TabsContent>
          </Tabs>
        </CardContent>
