  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        warning: "border-transparent bg-orange-500 text-white hover:bg-orange-600 shadow-sm",
        info: "border-transparent bg-blue-500 text-white hover:bg-blue-600 shadow-sm",
        gradient: "border-transparent gradient-primary text-white shadow-md hover:shadow-lg",
      },
    },
    defaultVariants: {
      variant: "default",
